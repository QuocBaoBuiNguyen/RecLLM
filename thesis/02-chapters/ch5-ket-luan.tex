...
được chuyển thành soft token cho LLM. Trên nền đó, luận văn bổ sung hai kỹ thuật huấn luyện --
điều kiện hóa truy vấn theo người dùng và mục tiêu bảo toàn thứ tự trong từng người dùng -- cùng
với biểu diễn đa token như một hệ quả của thiết kế nhiều truy vấn. Kết quả chi tiết được trình
bày ở Chương~\ref{Chapter4}.
...
\begin{itemize}
    ...
    điều kiện hóa truy vấn theo người dùng (Run-1), CoQLLM đạt $0{,}8147$/$0{,}5958$, vượt CoLLM-MF và
    BinLLM (theo lần chạy lại của CoRA) trên cả hai độ đo. Bổ sung hàm mất mát bảo toàn thứ tự
    (Run-2) nâng uAUC lên $0{,}6062$, tiệm cận CoRA-MF ($0{,}6262$).

    \item \textbf{Hai kỹ thuật tác động lên hai độ đo khác nhau.} Điều kiện hóa truy vấn theo người dùng
    chủ yếu cải thiện AUC (biến thiên giữa các người dùng); hàm mất mát bảo toàn thứ tự chủ yếu cải thiện
    ...
    $0{,}6238$ vs $0{,}5258$), cho thấy hướng cải thiện tiếp theo nằm ở chất lượng véc-tơ cộng tác
...
\begin{enumerate}
    ...
    projector, bảo toàn thứ tự trên MovieLens-1M), đây là phần thực nghiệm còn để ngỏ.
...
\begin{itemize}
    ...
    của uAUC.
    \item Mở rộng mục tiêu bảo toàn thứ tự (đã hiệu quả trên
