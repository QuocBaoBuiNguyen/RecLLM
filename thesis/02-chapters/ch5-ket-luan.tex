...
\begin{itemize}
    ...
    \item \textbf{Hai kỹ thuật tác động lên hai độ đo khác nhau.} \texttt{user\_conditioned}
    chủ yếu cải thiện AUC (biến thiên giữa các người dùng); \texttt{align\_rank\_loss} chủ yếu cải thiện
