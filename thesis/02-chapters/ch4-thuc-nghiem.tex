...
\begin{itemize}
    ...
    cáo AUC/uAUC theo bài toán CTR, nên không thể so sánh trực tiếp về số liệu; được
...
ILM~\cite{ilm2024} không báo cáo AUC/uAUC theo bài toán CTR, nên không thể so sánh
