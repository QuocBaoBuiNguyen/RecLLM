...
\begin{table}[ht]
\caption{Ablation hai kỹ thuật huấn luyện. Trên MovieLens-1M: bật \texttt{user\_conditioned}.
...
Trên MovieLens-1M, \texttt{user\_conditioned} chủ yếu tác động lên \textit{AUC} (+$0{,}014$), gần trung
tính với uAUC. Trên Amazon-Book, \texttt{align\_rank\_loss} chủ yếu tác động lên \textit{uAUC}
...
phân tích nghịch lý AUC/uAUC (Mục~\ref{sec:nghich-ly}) và chỉ ra hướng cải thiện tiếp theo
